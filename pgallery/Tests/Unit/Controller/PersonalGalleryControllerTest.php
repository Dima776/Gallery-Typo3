...
/**
 * Test case for class Tx_Pgallery_Controller_PersonalGalleryController.
 *
 * @version $Id$
 ...
 */
class PersonalGalleryControllerTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	/**
	 * @var 
	 */
	protected $fixture;
